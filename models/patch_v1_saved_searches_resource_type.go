...
// ContextValidate validates this patch v1 saved searches resource type based on context it is used
func (m *PatchV1SavedSearchesResourceType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
