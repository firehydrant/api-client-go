...
// IncidentEntityPaginated List all of the incidents in the organization
//
...
func (m *IncidentEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *IncidentEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *IncidentEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentEntityPaginated) UnmarshalBinary(b []byte) error {
	var res IncidentEntityPaginated
