...
func (m *IncidentsStatusPageEntityPaginated) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IncidentsStatusPageEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *IncidentsStatusPageEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *IncidentsStatusPageEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentsStatusPageEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentsStatusPageEntityPaginated) UnmarshalBinary(b []byte) error {
	var res IncidentsStatusPageEntityPaginated
