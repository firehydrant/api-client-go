...
func (m *AlertsAlertEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *AlertsAlertEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *AlertsAlertEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AlertsAlertEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AlertsAlertEntityPaginated) UnmarshalBinary(b []byte) error {
	var res AlertsAlertEntityPaginated
