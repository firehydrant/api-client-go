...
func (m *PostMortemsReasonEntityPaginated) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMortemsReasonEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *PostMortemsReasonEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *PostMortemsReasonEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PostMortemsReasonEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PostMortemsReasonEntityPaginated) UnmarshalBinary(b []byte) error {
	var res PostMortemsReasonEntityPaginated
