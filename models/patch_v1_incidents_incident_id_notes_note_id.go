...
func (m *PatchV1IncidentsIncidentIDNotesNoteID) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PatchV1IncidentsIncidentIDNotesNoteID) validateBody(formats strfmt.Registry) error {
...
func (m *PatchV1IncidentsIncidentIDNotesNoteID) UnmarshalBinary(b []byte) error {
	var res PatchV1IncidentsIncidentIDNotesNoteID
