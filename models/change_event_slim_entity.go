...
func (m *ChangeEventSlimEntity) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *ChangeEventSlimEntity) validateUpdatedAt(formats strfmt.Registry) error {
