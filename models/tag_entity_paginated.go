...
// TagEntityPaginated List all of the incident tags in the organization
//
...
func (m *TagEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *TagEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *TagEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TagEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
