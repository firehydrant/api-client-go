...
// TeamEntityPaginated Retrieve all teams
//
...
func (m *TeamEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *TeamEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *TeamEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TeamEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
