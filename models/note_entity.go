...
func (m *NoteEntity) validateConversations(formats strfmt.Registry) error {
...
func (m *NoteEntity) contextValidateConversations(ctx context.Context, formats strfmt.Registry) error {
