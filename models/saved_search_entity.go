...
func (m *SavedSearchEntity) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *SavedSearchEntity) validateUpdatedAt(formats strfmt.Registry) error {
