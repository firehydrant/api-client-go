...
func (m *ReasonEntity) validateConversations(formats strfmt.Registry) error {
...
func (m *ReasonEntity) contextValidateConversations(ctx context.Context, formats strfmt.Registry) error {
