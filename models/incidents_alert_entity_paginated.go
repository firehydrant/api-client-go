...
func (m *IncidentsAlertEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *IncidentsAlertEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *IncidentsAlertEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentsAlertEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentsAlertEntityPaginated) UnmarshalBinary(b []byte) error {
	var res IncidentsAlertEntityPaginated
