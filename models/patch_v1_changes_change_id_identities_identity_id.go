...
func (m *PatchV1ChangesChangeIDIdentitiesIdentityID) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PatchV1ChangesChangeIDIdentitiesIdentityID) validateType(formats strfmt.Registry) error {
...
func (m *PatchV1ChangesChangeIDIdentitiesIdentityID) validateValue(formats strfmt.Registry) error {
...
func (m *PatchV1ChangesChangeIDIdentitiesIdentityID) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *PatchV1ChangesChangeIDIdentitiesIdentityID) UnmarshalBinary(b []byte) error {
	var res PatchV1ChangesChangeIDIdentitiesIdentityID
