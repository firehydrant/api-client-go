...
func (m *ReportsBucketEntity) validatePoints(formats strfmt.Registry) error {
...
func (m *ReportsBucketEntity) contextValidatePoints(ctx context.Context, formats strfmt.Registry) error {
