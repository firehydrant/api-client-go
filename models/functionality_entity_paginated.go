...
func (m *FunctionalityEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *FunctionalityEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *FunctionalityEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FunctionalityEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FunctionalityEntityPaginated) UnmarshalBinary(b []byte) error {
	var res FunctionalityEntityPaginated
