...
func (m *AttachmentsLinkEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *AttachmentsLinkEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *AttachmentsLinkEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AttachmentsLinkEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AttachmentsLinkEntityPaginated) UnmarshalBinary(b []byte) error {
	var res AttachmentsLinkEntityPaginated
