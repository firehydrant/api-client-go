...
func (m *NuncConnectionEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *NuncConnectionEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *NuncConnectionEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NuncConnectionEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NuncConnectionEntityPaginated) UnmarshalBinary(b []byte) error {
	var res NuncConnectionEntityPaginated
