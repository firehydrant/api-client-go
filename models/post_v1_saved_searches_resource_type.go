...
func (m *PostV1SavedSearchesResourceType) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostV1SavedSearchesResourceType) validateFilterValues(formats strfmt.Registry) error {
...
func (m *PostV1SavedSearchesResourceType) validateName(formats strfmt.Registry) error {
...
func (m *PostV1SavedSearchesResourceType) UnmarshalBinary(b []byte) error {
	var res PostV1SavedSearchesResourceType
