...
func (m *IncidentsMilestoneEntityPaginated) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IncidentsMilestoneEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *IncidentsMilestoneEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *IncidentsMilestoneEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentsMilestoneEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentsMilestoneEntityPaginated) UnmarshalBinary(b []byte) error {
	var res IncidentsMilestoneEntityPaginated
