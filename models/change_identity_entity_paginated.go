...
func (m *ChangeIdentityEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *ChangeIdentityEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *ChangeIdentityEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChangeIdentityEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChangeIdentityEntityPaginated) UnmarshalBinary(b []byte) error {
	var res ChangeIdentityEntityPaginated
