...
func (m *EntitlementEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *EntitlementEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *EntitlementEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EntitlementEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EntitlementEntityPaginated) UnmarshalBinary(b []byte) error {
	var res EntitlementEntityPaginated
