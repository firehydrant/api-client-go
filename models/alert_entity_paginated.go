...
// ContextValidate validate this alert entity paginated based on the context it is used
func (m *AlertEntityPaginated) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AlertEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AlertEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
