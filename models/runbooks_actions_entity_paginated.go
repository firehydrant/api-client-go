...
func (m *RunbooksActionsEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *RunbooksActionsEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *RunbooksActionsEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RunbooksActionsEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RunbooksActionsEntityPaginated) UnmarshalBinary(b []byte) error {
	var res RunbooksActionsEntityPaginated
