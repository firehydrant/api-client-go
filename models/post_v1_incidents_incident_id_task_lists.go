...
func (m *PostV1IncidentsIncidentIDTaskLists) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostV1IncidentsIncidentIDTaskLists) validateTaskListID(formats strfmt.Registry) error {
...
func (m *PostV1IncidentsIncidentIDTaskLists) UnmarshalBinary(b []byte) error {
	var res PostV1IncidentsIncidentIDTaskLists
