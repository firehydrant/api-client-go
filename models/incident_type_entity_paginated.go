...
// IncidentTypeEntityPaginated List incident types
//
...
func (m *IncidentTypeEntityPaginated) validateData(formats strfmt.Registry) error {
...
func (m *IncidentTypeEntityPaginated) validatePagination(formats strfmt.Registry) error {
...
func (m *IncidentTypeEntityPaginated) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentTypeEntityPaginated) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IncidentTypeEntityPaginated) UnmarshalBinary(b []byte) error {
	var res IncidentTypeEntityPaginated
