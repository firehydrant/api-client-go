...
func (o *GetV1WebhooksWebhookIDDeliveriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/webhooks/{webhook_id}/deliveries] getV1WebhooksWebhookIdDeliveries", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 webhooks webhook Id deliveries o k response
func (o *GetV1WebhooksWebhookIDDeliveriesOK) Code() int {
	return 200
}
