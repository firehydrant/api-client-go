...
func (o *PatchV1IntegrationsConnectionsSlugConnectionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/integrations/connections/{slug}/{connection_id}] patchV1IntegrationsConnectionsSlugConnectionId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 integrations connections slug connection Id o k response
func (o *PatchV1IntegrationsConnectionsSlugConnectionIDOK) Code() int {
	return 200
}
