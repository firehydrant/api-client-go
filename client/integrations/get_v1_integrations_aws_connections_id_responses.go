...
func (o *GetV1IntegrationsAwsConnectionsIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/integrations/aws/connections/{id}] getV1IntegrationsAwsConnectionsId", response, response.Code())
	}
}
...
func (o *GetV1IntegrationsAwsConnectionsIDOK) IsSuccess() bool {
	return true
}
...
func (o *GetV1IntegrationsAwsConnectionsIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get v1 integrations aws connections Id o k response
func (o *GetV1IntegrationsAwsConnectionsIDOK) Code() int {
	return 200
}
...
func (o *GetV1IntegrationsAwsConnectionsIDOK) String() string {
	return fmt.Sprintf("[GET /v1/integrations/aws/connections/{id}][%d] getV1IntegrationsAwsConnectionsIdOK  %+v", 200, o.Payload)
}
