...
func (o *GetV1IntegrationsConfluenceCloudConnectionsIDSpaceSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/integrations/confluence_cloud/connections/{id}/space/search] getV1IntegrationsConfluenceCloudConnectionsIdSpaceSearch", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 integrations confluence cloud connections Id space search o k response
func (o *GetV1IntegrationsConfluenceCloudConnectionsIDSpaceSearchOK) Code() int {
	return 200
}
...
func (o *GetV1IntegrationsConfluenceCloudConnectionsIDSpaceSearchOK) GetPayload() *models.IntegrationsConfluenceCloudSpaceKeyEntity {
	return o.Payload
}
