...
func (o *PatchV1IntegrationsFieldMapsFieldMapIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/integrations/field_maps/{field_map_id}] patchV1IntegrationsFieldMapsFieldMapId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 integrations field maps field map Id o k response
func (o *PatchV1IntegrationsFieldMapsFieldMapIDOK) Code() int {
	return 200
}
