...
// GetV1IntegrationsStatuspageConnectionsIDPagesReader is a Reader for the GetV1IntegrationsStatuspageConnectionsIDPages structure.
type GetV1IntegrationsStatuspageConnectionsIDPagesReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *GetV1IntegrationsStatuspageConnectionsIDPagesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewGetV1IntegrationsStatuspageConnectionsIDPagesOK()
...
// NewGetV1IntegrationsStatuspageConnectionsIDPagesOK creates a GetV1IntegrationsStatuspageConnectionsIDPagesOK with default headers values
func NewGetV1IntegrationsStatuspageConnectionsIDPagesOK() *GetV1IntegrationsStatuspageConnectionsIDPagesOK {
...
func (o *GetV1IntegrationsStatuspageConnectionsIDPagesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
