...
func (o *GetV1IntegrationsConnectionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/integrations/connections] getV1IntegrationsConnections", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 integrations connections o k response
func (o *GetV1IntegrationsConnectionsOK) Code() int {
	return 200
}
