...
func (o *CreateConnectionCreated) Error() string {
	return fmt.Sprintf("[POST /v1/integrations/connections/{slug}][%d] createConnectionCreated  %+v", 201, o.Payload)
}
...
func (o *CreateConnectionCreated) GetPayload() *models.IntegrationsConnectionEntity {
	return o.Payload
}
