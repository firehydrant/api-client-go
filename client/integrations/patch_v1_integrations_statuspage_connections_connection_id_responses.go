...
func (o *PatchV1IntegrationsStatuspageConnectionsConnectionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/integrations/statuspage/connections/{connection_id}] patchV1IntegrationsStatuspageConnectionsConnectionId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 integrations statuspage connections connection Id o k response
func (o *PatchV1IntegrationsStatuspageConnectionsConnectionIDOK) Code() int {
	return 200
}
