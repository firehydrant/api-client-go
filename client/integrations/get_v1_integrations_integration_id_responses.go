...
func (o *GetV1IntegrationsIntegrationIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/integrations/{integration_id}] getV1IntegrationsIntegrationId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 integrations integration Id o k response
func (o *GetV1IntegrationsIntegrationIDOK) Code() int {
	return 200
}
