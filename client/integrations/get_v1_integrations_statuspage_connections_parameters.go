...
// NewGetV1IntegrationsStatuspageConnectionsParams creates a new GetV1IntegrationsStatuspageConnectionsParams object,
...
func NewGetV1IntegrationsStatuspageConnectionsParams() *GetV1IntegrationsStatuspageConnectionsParams {
	return &GetV1IntegrationsStatuspageConnectionsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetV1IntegrationsStatuspageConnectionsParamsWithTimeout creates a new GetV1IntegrationsStatuspageConnectionsParams object
...
// NewGetV1IntegrationsStatuspageConnectionsParamsWithContext creates a new GetV1IntegrationsStatuspageConnectionsParams object
...
// NewGetV1IntegrationsStatuspageConnectionsParamsWithHTTPClient creates a new GetV1IntegrationsStatuspageConnectionsParams object
...
func (o *GetV1IntegrationsStatuspageConnectionsParams) WithDefaults() *GetV1IntegrationsStatuspageConnectionsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetV1IntegrationsStatuspageConnectionsParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get v1 integrations statuspage connections params
func (o *GetV1IntegrationsStatuspageConnectionsParams) WithTimeout(timeout time.Duration) *GetV1IntegrationsStatuspageConnectionsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get v1 integrations statuspage connections params
func (o *GetV1IntegrationsStatuspageConnectionsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get v1 integrations statuspage connections params
func (o *GetV1IntegrationsStatuspageConnectionsParams) WithContext(ctx context.Context) *GetV1IntegrationsStatuspageConnectionsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get v1 integrations statuspage connections params
func (o *GetV1IntegrationsStatuspageConnectionsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get v1 integrations statuspage connections params
func (o *GetV1IntegrationsStatuspageConnectionsParams) WithHTTPClient(client *http.Client) *GetV1IntegrationsStatuspageConnectionsParams {
...
func (o *GetV1IntegrationsStatuspageConnectionsParams) WithPage(page *int32) *GetV1IntegrationsStatuspageConnectionsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get v1 integrations statuspage connections params
func (o *GetV1IntegrationsStatuspageConnectionsParams) SetPage(page *int32) {
	o.Page = page
}

// WithPerPage adds the perPage to the get v1 integrations statuspage connections params
func (o *GetV1IntegrationsStatuspageConnectionsParams) WithPerPage(perPage *int32) *GetV1IntegrationsStatuspageConnectionsParams {
...
func (o *GetV1IntegrationsStatuspageConnectionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
