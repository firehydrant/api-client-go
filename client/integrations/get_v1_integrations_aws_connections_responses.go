...
func (o *GetV1IntegrationsAwsConnectionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/integrations/aws/connections] getV1IntegrationsAwsConnections", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 integrations aws connections o k response
func (o *GetV1IntegrationsAwsConnectionsOK) Code() int {
	return 200
}
...
func (o *GetV1IntegrationsAwsConnectionsOK) String() string {
	return fmt.Sprintf("[GET /v1/integrations/aws/connections][%d] getV1IntegrationsAwsConnectionsOK  %+v", 200, o.Payload)
}

func (o *GetV1IntegrationsAwsConnectionsOK) GetPayload() *models.IntegrationsAwsConnectionEntityPaginated {
	return o.Payload
}
