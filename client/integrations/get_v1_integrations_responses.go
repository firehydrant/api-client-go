...
func (o *GetV1IntegrationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/integrations] getV1Integrations", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 integrations o k response
func (o *GetV1IntegrationsOK) Code() int {
	return 200
}
