...
func (o *GetV1IntegrationsOK) Error() string {
	return fmt.Sprintf("[GET /v1/integrations][%d] getV1IntegrationsOK  %+v", 200, o.Payload)
}
...
func (o *GetV1IntegrationsOK) GetPayload() *models.IntegrationsIntegrationEntityPaginated {
	return o.Payload
}
