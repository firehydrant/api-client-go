...
func (o *PatchV1IntegrationsAwsCloudtrailBatchesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/integrations/aws/cloudtrail_batches/{id}] patchV1IntegrationsAwsCloudtrailBatchesId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 integrations aws cloudtrail batches Id o k response
func (o *PatchV1IntegrationsAwsCloudtrailBatchesIDOK) Code() int {
	return 200
}
