...
func (o *GetV1TaskListsTaskListIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/task_lists/{task_list_id}] getV1TaskListsTaskListId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 task lists task list Id o k response
func (o *GetV1TaskListsTaskListIDOK) Code() int {
	return 200
}
