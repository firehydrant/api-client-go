...
func (o *PatchV1TaskListsTaskListIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/task_lists/{task_list_id}] patchV1TaskListsTaskListId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 task lists task list Id o k response
func (o *PatchV1TaskListsTaskListIDOK) Code() int {
	return 200
}
