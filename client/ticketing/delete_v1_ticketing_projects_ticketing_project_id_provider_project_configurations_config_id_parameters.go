...
func (o *DeleteV1TicketingProjectsTicketingProjectIDProviderProjectConfigurationsConfigIDParams) WithConfigID(configID string) *DeleteV1TicketingProjectsTicketingProjectIDProviderProjectConfigurationsConfigIDParams {
...
func (o *DeleteV1TicketingProjectsTicketingProjectIDProviderProjectConfigurationsConfigIDParams) SetConfigID(configID string) {
	o.ConfigID = configID
}
