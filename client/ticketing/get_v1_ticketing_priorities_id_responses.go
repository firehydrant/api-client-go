...
func (o *GetV1TicketingPrioritiesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/ticketing/priorities/{id}] getV1TicketingPrioritiesId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 ticketing priorities Id o k response
func (o *GetV1TicketingPrioritiesIDOK) Code() int {
	return 200
}
