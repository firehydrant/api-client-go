...
func (o *PatchV1TicketingPrioritiesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/ticketing/priorities/{id}] patchV1TicketingPrioritiesId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 ticketing priorities Id o k response
func (o *PatchV1TicketingPrioritiesIDOK) Code() int {
	return 200
}
...
func (o *PatchV1TicketingPrioritiesIDOK) GetPayload() *models.TicketingPriorityEntity {
	return o.Payload
}
