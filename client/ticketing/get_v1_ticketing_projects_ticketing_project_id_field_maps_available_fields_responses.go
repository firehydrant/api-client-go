...
func (o *GetV1TicketingProjectsTicketingProjectIDFieldMapsAvailableFieldsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/ticketing/projects/{ticketing_project_id}/field_maps/available_fields] getV1TicketingProjectsTicketingProjectIdFieldMapsAvailableFields", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 ticketing projects ticketing project Id field maps available fields o k response
func (o *GetV1TicketingProjectsTicketingProjectIDFieldMapsAvailableFieldsOK) Code() int {
	return 200
}
