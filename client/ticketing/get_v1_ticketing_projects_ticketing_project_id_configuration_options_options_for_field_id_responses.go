...
func (o *GetV1TicketingProjectsTicketingProjectIDConfigurationOptionsOptionsForFieldIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/ticketing/projects/{ticketing_project_id}/configuration_options/options_for/{field_id}] getV1TicketingProjectsTicketingProjectIdConfigurationOptionsOptionsForFieldId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 ticketing projects ticketing project Id configuration options options for field Id o k response
func (o *GetV1TicketingProjectsTicketingProjectIDConfigurationOptionsOptionsForFieldIDOK) Code() int {
	return 200
}
