...
func (o *GetV1TicketingProjectsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/ticketing/projects] getV1TicketingProjects", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 ticketing projects o k response
func (o *GetV1TicketingProjectsOK) Code() int {
	return 200
}
