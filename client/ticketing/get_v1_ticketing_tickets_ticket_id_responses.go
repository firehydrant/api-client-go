...
func (o *GetV1TicketingTicketsTicketIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/ticketing/tickets/{ticket_id}] getV1TicketingTicketsTicketId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 ticketing tickets ticket Id o k response
func (o *GetV1TicketingTicketsTicketIDOK) Code() int {
	return 200
}
