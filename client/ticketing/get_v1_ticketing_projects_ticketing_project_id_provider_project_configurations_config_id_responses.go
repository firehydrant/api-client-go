...
func (o *GetV1TicketingProjectsTicketingProjectIDProviderProjectConfigurationsConfigIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/ticketing/projects/{ticketing_project_id}/provider_project_configurations/{config_id}] getV1TicketingProjectsTicketingProjectIdProviderProjectConfigurationsConfigId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 ticketing projects ticketing project Id provider project configurations config Id o k response
func (o *GetV1TicketingProjectsTicketingProjectIDProviderProjectConfigurationsConfigIDOK) Code() int {
	return 200
}
