...
func (o *GetV1TicketingTicketsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/ticketing/tickets] getV1TicketingTickets", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 ticketing tickets o k response
func (o *GetV1TicketingTicketsOK) Code() int {
	return 200
}
