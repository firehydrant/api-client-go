...
func (o *PostV1NuncSubscriptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/nunc/subscriptions] postV1NuncSubscriptions", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 nunc subscriptions created response
func (o *PostV1NuncSubscriptionsCreated) Code() int {
	return 201
}
