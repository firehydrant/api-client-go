...
func (o *PatchV1CustomFieldsDefinitionsFieldIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchV1CustomFieldsDefinitionsFieldIDOK()
...
func NewPatchV1CustomFieldsDefinitionsFieldIDOK() *PatchV1CustomFieldsDefinitionsFieldIDOK {
	return &PatchV1CustomFieldsDefinitionsFieldIDOK{}
}
...
func (o *PatchV1CustomFieldsDefinitionsFieldIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this patch v1 custom fields definitions field Id o k response has a 3xx status code
func (o *PatchV1CustomFieldsDefinitionsFieldIDOK) IsRedirect() bool {
	return false
}
...
func (o *PatchV1CustomFieldsDefinitionsFieldIDOK) Error() string {
	return fmt.Sprintf("[PATCH /v1/custom_fields/definitions/{field_id}][%d] patchV1CustomFieldsDefinitionsFieldIdOK  %+v", 200, o.Payload)
}

func (o *PatchV1CustomFieldsDefinitionsFieldIDOK) String() string {
	return fmt.Sprintf("[PATCH /v1/custom_fields/definitions/{field_id}][%d] patchV1CustomFieldsDefinitionsFieldIdOK  %+v", 200, o.Payload)
}

func (o *PatchV1CustomFieldsDefinitionsFieldIDOK) GetPayload() *models.OrganizationsCustomFieldDefinitionEntity {
	return o.Payload
}

func (o *PatchV1CustomFieldsDefinitionsFieldIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
