...
func (o *PostV1CustomFieldsDefinitionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/custom_fields/definitions] postV1CustomFieldsDefinitions", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 custom fields definitions created response
func (o *PostV1CustomFieldsDefinitionsCreated) Code() int {
	return 201
}
