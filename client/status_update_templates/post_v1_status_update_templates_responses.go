...
func (o *PostV1StatusUpdateTemplatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/status_update_templates] postV1StatusUpdateTemplates", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 status update templates created response
func (o *PostV1StatusUpdateTemplatesCreated) Code() int {
	return 201
}
