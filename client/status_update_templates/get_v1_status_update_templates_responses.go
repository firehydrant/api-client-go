...
func (o *GetV1StatusUpdateTemplatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetV1StatusUpdateTemplatesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/status_update_templates] getV1StatusUpdateTemplates", response, response.Code())
	}
}
...
func NewGetV1StatusUpdateTemplatesOK() *GetV1StatusUpdateTemplatesOK {
	return &GetV1StatusUpdateTemplatesOK{}
}
...
// Code gets the status code for the get v1 status update templates o k response
func (o *GetV1StatusUpdateTemplatesOK) Code() int {
	return 200
}

func (o *GetV1StatusUpdateTemplatesOK) Error() string {
	return fmt.Sprintf("[GET /v1/status_update_templates][%d] getV1StatusUpdateTemplatesOK  %+v", 200, o.Payload)
}

func (o *GetV1StatusUpdateTemplatesOK) String() string {
	return fmt.Sprintf("[GET /v1/status_update_templates][%d] getV1StatusUpdateTemplatesOK  %+v", 200, o.Payload)
}

func (o *GetV1StatusUpdateTemplatesOK) GetPayload() *models.StatusUpdateTemplateEntity {
	return o.Payload
}

func (o *GetV1StatusUpdateTemplatesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
