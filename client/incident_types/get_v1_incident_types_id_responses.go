...
func (o *GetV1IncidentTypesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incident_types/{id}] getV1IncidentTypesId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incident types Id o k response
func (o *GetV1IncidentTypesIDOK) Code() int {
	return 200
}
