...
func (o *GetV1IncidentTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incident_types] getV1IncidentTypes", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incident types o k response
func (o *GetV1IncidentTypesOK) Code() int {
	return 200
}
