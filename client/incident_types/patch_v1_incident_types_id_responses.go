...
func (o *PatchV1IncidentTypesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/incident_types/{id}] patchV1IncidentTypesId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 incident types Id o k response
func (o *PatchV1IncidentTypesIDOK) Code() int {
	return 200
}
