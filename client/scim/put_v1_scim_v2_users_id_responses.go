...
func (o *PutV1ScimV2UsersIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /v1/scim/v2/Users/{id}] putV1ScimV2UsersId", response, response.Code())
	}
}
...
// Code gets the status code for the put v1 scim v2 users Id o k response
func (o *PutV1ScimV2UsersIDOK) Code() int {
	return 200
}
