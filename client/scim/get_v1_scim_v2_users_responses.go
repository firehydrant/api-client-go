...
func (o *GetV1ScimV2UsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/scim/v2/Users] getV1ScimV2Users", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 scim v2 users o k response
func (o *GetV1ScimV2UsersOK) Code() int {
	return 200
}
