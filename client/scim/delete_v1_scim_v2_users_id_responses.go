...
func (o *DeleteV1ScimV2UsersIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/scim/v2/Users/{id}] deleteV1ScimV2UsersId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 scim v2 users Id no content response
func (o *DeleteV1ScimV2UsersIDNoContent) Code() int {
	return 204
}
