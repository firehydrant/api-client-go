...
func (o *PutV1ScimV2GroupsIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /v1/scim/v2/Groups/{id}] putV1ScimV2GroupsId", response, response.Code())
	}
}
...
// Code gets the status code for the put v1 scim v2 groups Id o k response
func (o *PutV1ScimV2GroupsIDOK) Code() int {
	return 200
}
