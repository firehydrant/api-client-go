...
func (o *DeleteV1TeamsTeamIDSignalRulesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/teams/{team_id}/signal_rules/{id}] deleteV1TeamsTeamIdSignalRulesId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 teams team Id signal rules Id no content response
func (o *DeleteV1TeamsTeamIDSignalRulesIDNoContent) Code() int {
	return 204
}
