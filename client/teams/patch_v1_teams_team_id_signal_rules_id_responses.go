...
func (o *PatchV1TeamsTeamIDSignalRulesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/teams/{team_id}/signal_rules/{id}] patchV1TeamsTeamIdSignalRulesId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 teams team Id signal rules Id o k response
func (o *PatchV1TeamsTeamIDSignalRulesIDOK) Code() int {
	return 200
}
