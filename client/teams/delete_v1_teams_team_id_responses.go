...
func (o *DeleteV1TeamsTeamIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/teams/{team_id}] deleteV1TeamsTeamId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 teams team Id o k response
func (o *DeleteV1TeamsTeamIDOK) Code() int {
	return 200
}
