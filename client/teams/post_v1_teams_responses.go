...
func (o *PostV1TeamsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/teams] postV1Teams", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 teams created response
func (o *PostV1TeamsCreated) Code() int {
	return 201
}
