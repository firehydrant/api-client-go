...
func (o *GetV1TeamsTeamIDSignalRulesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/teams/{team_id}/signal_rules/{id}] getV1TeamsTeamIdSignalRulesId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 teams team Id signal rules Id o k response
func (o *GetV1TeamsTeamIDSignalRulesIDOK) Code() int {
	return 200
}
