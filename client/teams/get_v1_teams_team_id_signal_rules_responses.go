...
func (o *GetV1TeamsTeamIDSignalRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetV1TeamsTeamIDSignalRulesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/teams/{team_id}/signal_rules] getV1TeamsTeamIdSignalRules", response, response.Code())
	}
}
...
func NewGetV1TeamsTeamIDSignalRulesOK() *GetV1TeamsTeamIDSignalRulesOK {
	return &GetV1TeamsTeamIDSignalRulesOK{}
}
...
// Code gets the status code for the get v1 teams team Id signal rules o k response
func (o *GetV1TeamsTeamIDSignalRulesOK) Code() int {
	return 200
}

func (o *GetV1TeamsTeamIDSignalRulesOK) Error() string {
	return fmt.Sprintf("[GET /v1/teams/{team_id}/signal_rules][%d] getV1TeamsTeamIdSignalRulesOK ", 200)
}
...
func (o *GetV1TeamsTeamIDSignalRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
