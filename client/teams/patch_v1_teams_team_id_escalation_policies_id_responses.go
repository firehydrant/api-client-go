...
func (o *PatchV1TeamsTeamIDEscalationPoliciesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/teams/{team_id}/escalation_policies/{id}] patchV1TeamsTeamIdEscalationPoliciesId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 teams team Id escalation policies Id o k response
func (o *PatchV1TeamsTeamIDEscalationPoliciesIDOK) Code() int {
	return 200
}
