...
func (o *GetV1TeamsTeamIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/teams/{team_id}] getV1TeamsTeamId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 teams team Id o k response
func (o *GetV1TeamsTeamIDOK) Code() int {
	return 200
}
