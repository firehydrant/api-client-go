...
func (o *GetV1TeamsTeamIDOnCallSchedulesScheduleIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/teams/{team_id}/on_call_schedules/{schedule_id}] getV1TeamsTeamIdOnCallSchedulesScheduleId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 teams team Id on call schedules schedule Id o k response
func (o *GetV1TeamsTeamIDOnCallSchedulesScheduleIDOK) Code() int {
	return 200
}
