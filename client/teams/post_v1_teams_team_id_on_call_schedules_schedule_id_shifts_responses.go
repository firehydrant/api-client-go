...
func (o *PostV1TeamsTeamIDOnCallSchedulesScheduleIDShiftsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/teams/{team_id}/on_call_schedules/{schedule_id}/shifts] postV1TeamsTeamIdOnCallSchedulesScheduleIdShifts", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 teams team Id on call schedules schedule Id shifts created response
func (o *PostV1TeamsTeamIDOnCallSchedulesScheduleIDShiftsCreated) Code() int {
	return 201
}
