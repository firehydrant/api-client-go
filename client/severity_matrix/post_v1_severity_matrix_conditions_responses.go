...
func (o *PostV1SeverityMatrixConditionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/severity_matrix/conditions] postV1SeverityMatrixConditions", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 severity matrix conditions created response
func (o *PostV1SeverityMatrixConditionsCreated) Code() int {
	return 201
}
