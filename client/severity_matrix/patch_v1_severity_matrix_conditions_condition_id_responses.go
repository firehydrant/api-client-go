...
func (o *PatchV1SeverityMatrixConditionsConditionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/severity_matrix/conditions/{condition_id}] patchV1SeverityMatrixConditionsConditionId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 severity matrix conditions condition Id o k response
func (o *PatchV1SeverityMatrixConditionsConditionIDOK) Code() int {
	return 200
}
