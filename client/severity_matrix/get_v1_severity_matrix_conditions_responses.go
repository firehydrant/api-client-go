...
func (o *GetV1SeverityMatrixConditionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/severity_matrix/conditions] getV1SeverityMatrixConditions", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 severity matrix conditions o k response
func (o *GetV1SeverityMatrixConditionsOK) Code() int {
	return 200
}
