...
func (o *DeleteV1SeverityMatrixConditionsConditionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/severity_matrix/conditions/{condition_id}] deleteV1SeverityMatrixConditionsConditionId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 severity matrix conditions condition Id o k response
func (o *DeleteV1SeverityMatrixConditionsConditionIDOK) Code() int {
	return 200
}
