...
func (o *DeleteV1PrioritiesPrioritySlugReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/priorities/{priority_slug}] deleteV1PrioritiesPrioritySlug", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 priorities priority slug o k response
func (o *DeleteV1PrioritiesPrioritySlugOK) Code() int {
	return 200
}
