...
func (o *PatchV1PrioritiesPrioritySlugReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/priorities/{priority_slug}] patchV1PrioritiesPrioritySlug", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 priorities priority slug o k response
func (o *PatchV1PrioritiesPrioritySlugOK) Code() int {
	return 200
}
