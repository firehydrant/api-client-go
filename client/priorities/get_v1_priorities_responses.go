...
func (o *GetV1PrioritiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/priorities] getV1Priorities", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 priorities o k response
func (o *GetV1PrioritiesOK) Code() int {
	return 200
}
