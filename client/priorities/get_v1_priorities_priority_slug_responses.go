...
func (o *GetV1PrioritiesPrioritySlugReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/priorities/{priority_slug}] getV1PrioritiesPrioritySlug", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 priorities priority slug o k response
func (o *GetV1PrioritiesPrioritySlugOK) Code() int {
	return 200
}
