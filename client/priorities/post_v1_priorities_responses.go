...
func (o *PostV1PrioritiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/priorities] postV1Priorities", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 priorities created response
func (o *PostV1PrioritiesCreated) Code() int {
	return 201
}
