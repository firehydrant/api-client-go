...
func (o *PostV1PostMortemsReportsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/post_mortems/reports] postV1PostMortemsReports", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 post mortems reports created response
func (o *PostV1PostMortemsReportsCreated) Code() int {
	return 201
}
