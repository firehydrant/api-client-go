...
func (o *GetV1PostMortemsReportsReportIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/post_mortems/reports/{report_id}] getV1PostMortemsReportsReportId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 post mortems reports report Id o k response
func (o *GetV1PostMortemsReportsReportIDOK) Code() int {
	return 200
}
