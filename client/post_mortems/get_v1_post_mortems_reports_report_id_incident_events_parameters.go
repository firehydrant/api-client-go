...
// WithDefaults hydrates default values in the get v1 post mortems reports report Id incident events params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetV1PostMortemsReportsReportIDIncidentEventsParams) WithDefaults() *GetV1PostMortemsReportsReportIDIncidentEventsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get v1 post mortems reports report Id incident events params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetV1PostMortemsReportsReportIDIncidentEventsParams) SetDefaults() {
