...
/* GetV1PostMortemsTagsParams contains all the parameters to send to the API endpoint
   for the get v1 post mortems tags operation.
...
// WithDefaults hydrates default values in the get v1 post mortems tags params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetV1PostMortemsTagsParams) WithDefaults() *GetV1PostMortemsTagsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get v1 post mortems tags params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetV1PostMortemsTagsParams) SetDefaults() {
