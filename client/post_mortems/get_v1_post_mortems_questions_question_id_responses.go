...
func (o *GetV1PostMortemsQuestionsQuestionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/post_mortems/questions/{question_id}] getV1PostMortemsQuestionsQuestionId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 post mortems questions question Id o k response
func (o *GetV1PostMortemsQuestionsQuestionIDOK) Code() int {
	return 200
}
