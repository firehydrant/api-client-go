...
func (o *PutV1PostMortemsReportsReportIDReasonsOrderReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /v1/post_mortems/reports/{report_id}/reasons/order] putV1PostMortemsReportsReportIdReasonsOrder", response, response.Code())
	}
}
...
// Code gets the status code for the put v1 post mortems reports report Id reasons order o k response
func (o *PutV1PostMortemsReportsReportIDReasonsOrderOK) Code() int {
	return 200
}
