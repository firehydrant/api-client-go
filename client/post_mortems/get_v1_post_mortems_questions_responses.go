...
func (o *GetV1PostMortemsQuestionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/post_mortems/questions] getV1PostMortemsQuestions", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 post mortems questions o k response
func (o *GetV1PostMortemsQuestionsOK) Code() int {
	return 200
}
