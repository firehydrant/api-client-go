...
/* PatchV1PostMortemsReportsReportIDActionItemsActionItemIDParams contains all the parameters to send to the API endpoint
   for the patch v1 post mortems reports report Id action items action item Id operation.
...
// WithDefaults hydrates default values in the patch v1 post mortems reports report Id action items action item Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchV1PostMortemsReportsReportIDActionItemsActionItemIDParams) WithDefaults() *PatchV1PostMortemsReportsReportIDActionItemsActionItemIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the patch v1 post mortems reports report Id action items action item Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchV1PostMortemsReportsReportIDActionItemsActionItemIDParams) SetDefaults() {
