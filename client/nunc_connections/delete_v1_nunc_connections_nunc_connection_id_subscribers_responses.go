...
func (o *DeleteV1NuncConnectionsNuncConnectionIDSubscribersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/nunc_connections/{nunc_connection_id}/subscribers] deleteV1NuncConnectionsNuncConnectionIdSubscribers", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 nunc connections nunc connection Id subscribers o k response
func (o *DeleteV1NuncConnectionsNuncConnectionIDSubscribersOK) Code() int {
	return 200
}
