...
func (o *PutV1NuncConnectionsNuncConnectionIDImagesTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutV1NuncConnectionsNuncConnectionIDImagesTypeOK()
...
func NewPutV1NuncConnectionsNuncConnectionIDImagesTypeOK() *PutV1NuncConnectionsNuncConnectionIDImagesTypeOK {
	return &PutV1NuncConnectionsNuncConnectionIDImagesTypeOK{}
}
...
func (o *PutV1NuncConnectionsNuncConnectionIDImagesTypeOK) Error() string {
	return fmt.Sprintf("[PUT /v1/nunc_connections/{nunc_connection_id}/images/{type}][%d] putV1NuncConnectionsNuncConnectionIdImagesTypeOK  %+v", 200, o.Payload)
}
...
func (o *PutV1NuncConnectionsNuncConnectionIDImagesTypeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
