...
func (o *DeleteV1NuncConnectionsNuncConnectionIDImagesTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/nunc_connections/{nunc_connection_id}/images/{type}] deleteV1NuncConnectionsNuncConnectionIdImagesType", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 nunc connections nunc connection Id images type o k response
func (o *DeleteV1NuncConnectionsNuncConnectionIDImagesTypeOK) Code() int {
	return 200
}
