...
func (o *PostV1NuncConnectionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/nunc_connections] postV1NuncConnections", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 nunc connections created response
func (o *PostV1NuncConnectionsCreated) Code() int {
	return 201
}
