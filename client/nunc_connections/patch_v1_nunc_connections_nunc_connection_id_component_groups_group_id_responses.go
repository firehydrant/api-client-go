...
func (o *PatchV1NuncConnectionsNuncConnectionIDComponentGroupsGroupIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/nunc_connections/{nunc_connection_id}/component_groups/{group_id}] patchV1NuncConnectionsNuncConnectionIdComponentGroupsGroupId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 nunc connections nunc connection Id component groups group Id o k response
func (o *PatchV1NuncConnectionsNuncConnectionIDComponentGroupsGroupIDOK) Code() int {
	return 200
}
