...
func (o *GetV1NuncConnectionsNuncConnectionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/nunc_connections/{nunc_connection_id}] getV1NuncConnectionsNuncConnectionId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 nunc connections nunc connection Id o k response
func (o *GetV1NuncConnectionsNuncConnectionIDOK) Code() int {
	return 200
}
