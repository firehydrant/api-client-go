...
func (o *PostV1NuncConnectionsNuncConnectionIDSubscribersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/nunc_connections/{nunc_connection_id}/subscribers] postV1NuncConnectionsNuncConnectionIdSubscribers", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 nunc connections nunc connection Id subscribers created response
func (o *PostV1NuncConnectionsNuncConnectionIDSubscribersCreated) Code() int {
	return 201
}
