...
func (o *DeleteV1NuncConnectionsNuncConnectionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/nunc_connections/{nunc_connection_id}] deleteV1NuncConnectionsNuncConnectionId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 nunc connections nunc connection Id o k response
func (o *DeleteV1NuncConnectionsNuncConnectionIDOK) Code() int {
	return 200
}
