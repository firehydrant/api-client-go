...
func (o *PatchV1ServiceDependenciesServiceDependencyIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/service_dependencies/{service_dependency_id}] patchV1ServiceDependenciesServiceDependencyId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 service dependencies service dependency Id o k response
func (o *PatchV1ServiceDependenciesServiceDependencyIDOK) Code() int {
	return 200
}
