...
func (o *PostV1ServiceDependenciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/service_dependencies] postV1ServiceDependencies", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 service dependencies created response
func (o *PostV1ServiceDependenciesCreated) Code() int {
	return 201
}
