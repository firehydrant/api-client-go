...
func (o *GetV1ServiceDependenciesServiceDependencyIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/service_dependencies/{service_dependency_id}] getV1ServiceDependenciesServiceDependencyId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 service dependencies service dependency Id o k response
func (o *GetV1ServiceDependenciesServiceDependencyIDOK) Code() int {
	return 200
}
