...
func (o *GetV1InfrastructuresReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/infrastructures] getV1Infrastructures", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 infrastructures o k response
func (o *GetV1InfrastructuresOK) Code() int {
	return 200
}
