...
func (o *GetV1UsersIDServicesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/users/{id}/services] getV1UsersIdServices", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 users Id services o k response
func (o *GetV1UsersIDServicesOK) Code() int {
	return 200
}
