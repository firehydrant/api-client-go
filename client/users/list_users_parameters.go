...
// WithName adds the name to the list users params
func (o *ListUsersParams) WithName(name *string) *ListUsersParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the list users params
func (o *ListUsersParams) SetName(name *string) {
	o.Name = name
}

// WithPage adds the page to the list users params
func (o *ListUsersParams) WithPage(page *int32) *ListUsersParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the list users params
func (o *ListUsersParams) SetPage(page *int32) {
	o.Page = page
}

// WithPerPage adds the perPage to the list users params
func (o *ListUsersParams) WithPerPage(perPage *int32) *ListUsersParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the list users params
func (o *ListUsersParams) SetPerPage(perPage *int32) {
	o.PerPage = perPage
}
