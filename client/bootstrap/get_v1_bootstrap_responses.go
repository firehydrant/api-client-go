...
func (o *GetV1BootstrapReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/bootstrap] getV1Bootstrap", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 bootstrap o k response
func (o *GetV1BootstrapOK) Code() int {
	return 200
}
