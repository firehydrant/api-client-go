...
func (o *GetV1AlertsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/alerts] getV1Alerts", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 alerts o k response
func (o *GetV1AlertsOK) Code() int {
	return 200
}
