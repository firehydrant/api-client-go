...
func (o *GetV1AlertsAlertIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/alerts/{alert_id}] getV1AlertsAlertId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 alerts alert Id o k response
func (o *GetV1AlertsAlertIDOK) Code() int {
	return 200
}
