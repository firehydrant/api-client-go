...
func (o *UpdateEnvironmentOK) Error() string {
	return fmt.Sprintf("[PATCH /v1/environments/{environment_id}][%d] updateEnvironmentOK  %+v", 200, o.Payload)
}
...
func (o *UpdateEnvironmentOK) GetPayload() *models.EnvironmentEntryEntity {
	return o.Payload
}
