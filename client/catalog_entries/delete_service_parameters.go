...
// WithServiceID adds the serviceID to the delete service params
func (o *DeleteServiceParams) WithServiceID(serviceID string) *DeleteServiceParams {
	o.SetServiceID(serviceID)
	return o
}

// SetServiceID adds the serviceId to the delete service params
func (o *DeleteServiceParams) SetServiceID(serviceID string) {
