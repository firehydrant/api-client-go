...
func (o *CreateEnvironmentCreated) Error() string {
	return fmt.Sprintf("[POST /v1/environments][%d] createEnvironmentCreated  %+v", 201, o.Payload)
}
...
func (o *CreateEnvironmentCreated) GetPayload() *models.EnvironmentEntryEntity {
	return o.Payload
}
