...
type CreateServiceParams struct {
	...
	// CreateService.
	CreateService *models.CreateService
...
// WithCreateService adds the createService to the create service params
func (o *CreateServiceParams) WithCreateService(createService *models.CreateService) *CreateServiceParams {
	o.SetCreateService(createService)
	return o
}

// SetCreateService adds the createService to the create service params
func (o *CreateServiceParams) SetCreateService(createService *models.CreateService) {
	o.CreateService = createService
}
...
func (o *CreateServiceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.CreateService != nil {
		if err := r.SetBodyParam(o.CreateService); err != nil {
			return err
		}
	}
