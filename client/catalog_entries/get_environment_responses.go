...
func (o *GetEnvironmentOK) Error() string {
	return fmt.Sprintf("[GET /v1/environments/{environment_id}][%d] getEnvironmentOK  %+v", 200, o.Payload)
}
...
func (o *GetEnvironmentOK) GetPayload() *models.EnvironmentEntryEntity {
	return o.Payload
}
