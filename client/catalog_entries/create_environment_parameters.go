...
type CreateEnvironmentParams struct {
	...
	// CreateEnvironment.
	CreateEnvironment *models.CreateEnvironment
...
// WithCreateEnvironment adds the createEnvironment to the create environment params
func (o *CreateEnvironmentParams) WithCreateEnvironment(createEnvironment *models.CreateEnvironment) *CreateEnvironmentParams {
	o.SetCreateEnvironment(createEnvironment)
	return o
}

// SetCreateEnvironment adds the createEnvironment to the create environment params
func (o *CreateEnvironmentParams) SetCreateEnvironment(createEnvironment *models.CreateEnvironment) {
	o.CreateEnvironment = createEnvironment
}
...
func (o *CreateEnvironmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.CreateEnvironment != nil {
		if err := r.SetBodyParam(o.CreateEnvironment); err != nil {
			return err
		}
	}
