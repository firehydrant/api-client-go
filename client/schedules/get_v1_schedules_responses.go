...
func (o *GetV1SchedulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/schedules] getV1Schedules", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 schedules o k response
func (o *GetV1SchedulesOK) Code() int {
	return 200
}
