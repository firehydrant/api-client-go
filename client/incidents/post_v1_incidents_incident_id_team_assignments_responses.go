...
func (o *PostV1IncidentsIncidentIDTeamAssignmentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/incidents/{incident_id}/team_assignments] postV1IncidentsIncidentIdTeamAssignments", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 incidents incident Id team assignments created response
func (o *PostV1IncidentsIncidentIDTeamAssignmentsCreated) Code() int {
	return 201
}
