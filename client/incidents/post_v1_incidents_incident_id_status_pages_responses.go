...
func (o *PostV1IncidentsIncidentIDStatusPagesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/incidents/{incident_id}/status_pages] postV1IncidentsIncidentIdStatusPages", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 incidents incident Id status pages created response
func (o *PostV1IncidentsIncidentIDStatusPagesCreated) Code() int {
	return 201
}
