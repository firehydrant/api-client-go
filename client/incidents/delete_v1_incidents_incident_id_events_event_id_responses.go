...
func (o *DeleteV1IncidentsIncidentIDEventsEventIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/incidents/{incident_id}/events/{event_id}] deleteV1IncidentsIncidentIdEventsEventId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 incidents incident Id events event Id o k response
func (o *DeleteV1IncidentsIncidentIDEventsEventIDOK) Code() int {
	return 200
}
