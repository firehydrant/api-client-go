...
func (o *PatchV1IncidentsIncidentIDEventsEventIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/incidents/{incident_id}/events/{event_id}] patchV1IncidentsIncidentIdEventsEventId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 incidents incident Id events event Id o k response
func (o *PatchV1IncidentsIncidentIDEventsEventIDOK) Code() int {
	return 200
}
