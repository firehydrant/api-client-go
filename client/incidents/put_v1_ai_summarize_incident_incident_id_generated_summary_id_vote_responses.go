...
func (o *PutV1AiSummarizeIncidentIncidentIDGeneratedSummaryIDVoteOK) Error() string {
	return fmt.Sprintf("[PUT /v1/ai/summarize_incident/{incident_id}/{generated_summary_id}/vote][%d] putV1AiSummarizeIncidentIncidentIdGeneratedSummaryIdVoteOK  %+v", 200, o.Payload)
}
...
func (o *PutV1AiSummarizeIncidentIncidentIDGeneratedSummaryIDVoteOK) GetPayload() *models.AIEntitiesIncidentSummaryEntity {
	return o.Payload
}
