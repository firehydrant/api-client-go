...
func (o *PostV1IncidentsIncidentIDLinksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/incidents/{incident_id}/links] postV1IncidentsIncidentIdLinks", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 incidents incident Id links created response
func (o *PostV1IncidentsIncidentIDLinksCreated) Code() int {
	return 201
}
