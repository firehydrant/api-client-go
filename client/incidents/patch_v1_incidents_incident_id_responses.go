...
func (o *PatchV1IncidentsIncidentIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/incidents/{incident_id}] patchV1IncidentsIncidentId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 incidents incident Id o k response
func (o *PatchV1IncidentsIncidentIDOK) Code() int {
	return 200
}
