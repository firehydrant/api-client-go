...
func (o *DeleteV1IncidentsIncidentIDRoleAssignmentsRoleAssignmentIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/incidents/{incident_id}/role_assignments/{role_assignment_id}] deleteV1IncidentsIncidentIdRoleAssignmentsRoleAssignmentId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 incidents incident Id role assignments role assignment Id o k response
func (o *DeleteV1IncidentsIncidentIDRoleAssignmentsRoleAssignmentIDOK) Code() int {
	return 200
}
