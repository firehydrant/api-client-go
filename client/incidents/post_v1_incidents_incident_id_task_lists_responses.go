...
func (o *PostV1IncidentsIncidentIDTaskListsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/incidents/{incident_id}/task_lists] postV1IncidentsIncidentIdTaskLists", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 incidents incident Id task lists created response
func (o *PostV1IncidentsIncidentIDTaskListsCreated) Code() int {
	return 201
}
