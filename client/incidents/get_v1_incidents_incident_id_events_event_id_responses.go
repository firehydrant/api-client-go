...
func (o *GetV1IncidentsIncidentIDEventsEventIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/events/{event_id}] getV1IncidentsIncidentIdEventsEventId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id events event Id o k response
func (o *GetV1IncidentsIncidentIDEventsEventIDOK) Code() int {
	return 200
}
