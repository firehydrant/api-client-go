...
func (o *DeleteV1IncidentsIncidentIDAlertsIncidentAlertIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/incidents/{incident_id}/alerts/{incident_alert_id}] deleteV1IncidentsIncidentIdAlertsIncidentAlertId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 incidents incident Id alerts incident alert Id no content response
func (o *DeleteV1IncidentsIncidentIDAlertsIncidentAlertIDNoContent) Code() int {
	return 204
}
