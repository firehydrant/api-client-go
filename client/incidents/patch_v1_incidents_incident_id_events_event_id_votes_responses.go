...
func (o *PatchV1IncidentsIncidentIDEventsEventIDVotesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/incidents/{incident_id}/events/{event_id}/votes] patchV1IncidentsIncidentIdEventsEventIdVotes", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 incidents incident Id events event Id votes o k response
func (o *PatchV1IncidentsIncidentIDEventsEventIDVotesOK) Code() int {
	return 200
}
