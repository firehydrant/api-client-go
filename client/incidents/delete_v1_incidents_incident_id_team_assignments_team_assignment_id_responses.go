...
func (o *DeleteV1IncidentsIncidentIDTeamAssignmentsTeamAssignmentIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/incidents/{incident_id}/team_assignments/{team_assignment_id}] deleteV1IncidentsIncidentIdTeamAssignmentsTeamAssignmentId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 incidents incident Id team assignments team assignment Id no content response
func (o *DeleteV1IncidentsIncidentIDTeamAssignmentsTeamAssignmentIDNoContent) Code() int {
	return 204
}
