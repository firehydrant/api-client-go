...
func (o *GetV1IncidentsIncidentIDEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/events] getV1IncidentsIncidentIdEvents", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id events o k response
func (o *GetV1IncidentsIncidentIDEventsOK) Code() int {
	return 200
}
