...
func (o *GetV1IncidentsIncidentIDImpactTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/impact/{type}] getV1IncidentsIncidentIdImpactType", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id impact type o k response
func (o *GetV1IncidentsIncidentIDImpactTypeOK) Code() int {
	return 200
}
