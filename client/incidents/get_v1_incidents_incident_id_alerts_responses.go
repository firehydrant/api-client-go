...
func (o *GetV1IncidentsIncidentIDAlertsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/alerts] getV1IncidentsIncidentIdAlerts", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id alerts o k response
func (o *GetV1IncidentsIncidentIDAlertsOK) Code() int {
	return 200
}
