...
func (o *DeleteV1IncidentsIncidentIDLinksLinkIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/incidents/{incident_id}/links/{link_id}] deleteV1IncidentsIncidentIdLinksLinkId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 incidents incident Id links link Id no content response
func (o *DeleteV1IncidentsIncidentIDLinksLinkIDNoContent) Code() int {
	return 204
}
