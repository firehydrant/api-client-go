...
func (o *GetV1IncidentsIncidentIDRoleAssignmentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/role_assignments] getV1IncidentsIncidentIdRoleAssignments", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id role assignments o k response
func (o *GetV1IncidentsIncidentIDRoleAssignmentsOK) Code() int {
	return 200
}
