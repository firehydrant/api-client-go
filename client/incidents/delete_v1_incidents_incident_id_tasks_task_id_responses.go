...
func (o *DeleteV1IncidentsIncidentIDTasksTaskIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/incidents/{incident_id}/tasks/{task_id}] deleteV1IncidentsIncidentIdTasksTaskId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 incidents incident Id tasks task Id no content response
func (o *DeleteV1IncidentsIncidentIDTasksTaskIDNoContent) Code() int {
	return 204
}
