...
func (o *GetV1IncidentsIncidentIDAttachmentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/attachments] getV1IncidentsIncidentIdAttachments", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id attachments o k response
func (o *GetV1IncidentsIncidentIDAttachmentsOK) Code() int {
	return 200
}
