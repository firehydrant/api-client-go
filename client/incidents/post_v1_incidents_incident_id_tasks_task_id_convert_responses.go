...
func (o *PostV1IncidentsIncidentIDTasksTaskIDConvertReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/incidents/{incident_id}/tasks/{task_id}/convert] postV1IncidentsIncidentIdTasksTaskIdConvert", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 incidents incident Id tasks task Id convert created response
func (o *PostV1IncidentsIncidentIDTasksTaskIDConvertCreated) Code() int {
	return 201
}
