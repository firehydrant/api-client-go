...
func (o *PostV1IncidentsIncidentIDNotesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/incidents/{incident_id}/notes] postV1IncidentsIncidentIdNotes", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 incidents incident Id notes created response
func (o *PostV1IncidentsIncidentIDNotesCreated) Code() int {
	return 201
}
