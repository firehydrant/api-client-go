...
func (o *PutV1IncidentsIncidentIDImpactParams) WithIncidentID(incidentID int32) *PutV1IncidentsIncidentIDImpactParams {
	o.SetIncidentID(incidentID)
	return o
}

// SetIncidentID adds the incidentId to the put v1 incidents incident Id impact params
func (o *PutV1IncidentsIncidentIDImpactParams) SetIncidentID(incidentID int32) {
