...
func (o *PostV1IncidentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/incidents] postV1Incidents", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 incidents created response
func (o *PostV1IncidentsCreated) Code() int {
	return 201
}
