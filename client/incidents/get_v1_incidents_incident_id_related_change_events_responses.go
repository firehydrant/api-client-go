...
func (o *GetV1IncidentsIncidentIDRelatedChangeEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/related_change_events] getV1IncidentsIncidentIdRelatedChangeEvents", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id related change events o k response
func (o *GetV1IncidentsIncidentIDRelatedChangeEventsOK) Code() int {
	return 200
}
