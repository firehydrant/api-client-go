...
func (o *PutV1IncidentsIncidentIDLinksLinkIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /v1/incidents/{incident_id}/links/{link_id}] putV1IncidentsIncidentIdLinksLinkId", response, response.Code())
	}
}
...
// Code gets the status code for the put v1 incidents incident Id links link Id o k response
func (o *PutV1IncidentsIncidentIDLinksLinkIDOK) Code() int {
	return 200
}
