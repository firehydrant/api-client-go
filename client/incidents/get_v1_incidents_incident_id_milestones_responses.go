...
func (o *GetV1IncidentsIncidentIDMilestonesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/milestones] getV1IncidentsIncidentIdMilestones", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id milestones o k response
func (o *GetV1IncidentsIncidentIDMilestonesOK) Code() int {
	return 200
}
