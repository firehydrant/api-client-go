...
func (o *GetV1IncidentsIncidentIDTranscriptReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incidents/{incident_id}/transcript] getV1IncidentsIncidentIdTranscript", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incidents incident Id transcript o k response
func (o *GetV1IncidentsIncidentIDTranscriptOK) Code() int {
	return 200
}
