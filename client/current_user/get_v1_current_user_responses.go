...
func (o *GetV1CurrentUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetV1CurrentUserOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/current_user] getV1CurrentUser", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 current user o k response
func (o *GetV1CurrentUserOK) Code() int {
	return 200
}
