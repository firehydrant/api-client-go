...
func (o *PostV1ChangesEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/changes/events] postV1ChangesEvents", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 changes events created response
func (o *PostV1ChangesEventsCreated) Code() int {
	return 201
}
