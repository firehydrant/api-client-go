...
func (o *GetV1ChangesChangeIDIdentitiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/changes/{change_id}/identities] getV1ChangesChangeIdIdentities", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 changes change Id identities o k response
func (o *GetV1ChangesChangeIDIdentitiesOK) Code() int {
	return 200
}
