...
func (o *PatchV1ChangesEventsChangeEventIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/changes/events/{change_event_id}] patchV1ChangesEventsChangeEventId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 changes events change event Id o k response
func (o *PatchV1ChangesEventsChangeEventIDOK) Code() int {
	return 200
}
