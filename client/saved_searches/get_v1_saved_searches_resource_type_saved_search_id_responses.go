...
func (o *GetV1SavedSearchesResourceTypeSavedSearchIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/saved_searches/{resource_type}/{saved_search_id}] getV1SavedSearchesResourceTypeSavedSearchId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 saved searches resource type saved search Id o k response
func (o *GetV1SavedSearchesResourceTypeSavedSearchIDOK) Code() int {
	return 200
}
