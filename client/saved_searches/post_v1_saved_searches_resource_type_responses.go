...
func (o *PostV1SavedSearchesResourceTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/saved_searches/{resource_type}] postV1SavedSearchesResourceType", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 saved searches resource type created response
func (o *PostV1SavedSearchesResourceTypeCreated) Code() int {
	return 201
}
