...
func (o *GetV1SavedSearchesResourceTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/saved_searches/{resource_type}] getV1SavedSearchesResourceType", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 saved searches resource type o k response
func (o *GetV1SavedSearchesResourceTypeOK) Code() int {
	return 200
}
