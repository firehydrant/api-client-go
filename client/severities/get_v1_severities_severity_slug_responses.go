...
func (o *GetV1SeveritiesSeveritySlugReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/severities/{severity_slug}] getV1SeveritiesSeveritySlug", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 severities severity slug o k response
func (o *GetV1SeveritiesSeveritySlugOK) Code() int {
	return 200
}
