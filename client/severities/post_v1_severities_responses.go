...
func (o *PostV1SeveritiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/severities] postV1Severities", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 severities created response
func (o *PostV1SeveritiesCreated) Code() int {
	return 201
}
