...
func (o *DeleteV1ServicesServiceIDParams) WithServiceID(serviceID string) *DeleteV1ServicesServiceIDParams {
	o.SetServiceID(serviceID)
	return o
}

// SetServiceID adds the serviceId to the delete v1 services service Id params
func (o *DeleteV1ServicesServiceIDParams) SetServiceID(serviceID string) {
