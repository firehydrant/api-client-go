...
func (o *GetV1ServicesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/services] getV1Services", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 services o k response
func (o *GetV1ServicesOK) Code() int {
	return 200
}
