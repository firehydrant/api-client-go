...
func (o *PostV1ServicesServiceLinksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/services/service_links] postV1ServicesServiceLinks", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 services service links created response
func (o *PostV1ServicesServiceLinksCreated) Code() int {
	return 201
}
