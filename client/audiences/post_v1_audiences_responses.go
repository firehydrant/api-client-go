...
func (o *PostV1AudiencesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewPostV1AudiencesCreated()
...
func (o *PostV1AudiencesCreated) Error() string {
	return fmt.Sprintf("[POST /v1/audiences][%d] postV1AudiencesCreated  %+v", 201, o.Payload)
}
...
func (o *PostV1AudiencesCreated) GetPayload() *models.AudiencesEntitiesAudienceEntity {
	return o.Payload
}

func (o *PostV1AudiencesCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
