...
func (o *GetV1AudiencesAudienceIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetV1AudiencesAudienceIDOK()
...
func NewGetV1AudiencesAudienceIDOK() *GetV1AudiencesAudienceIDOK {
	return &GetV1AudiencesAudienceIDOK{}
}
...
func (o *GetV1AudiencesAudienceIDOK) Error() string {
	return fmt.Sprintf("[GET /v1/audiences/{audience_id}][%d] getV1AudiencesAudienceIdOK  %+v", 200, o.Payload)
}
...
func (o *GetV1AudiencesAudienceIDOK) GetPayload() *models.AudiencesEntitiesAudienceEntity {
	return o.Payload
}

func (o *GetV1AudiencesAudienceIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
