...
func (o *GetV1RunbooksExecutionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbooks/executions] getV1RunbooksExecutions", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbooks executions o k response
func (o *GetV1RunbooksExecutionsOK) Code() int {
	return 200
}
