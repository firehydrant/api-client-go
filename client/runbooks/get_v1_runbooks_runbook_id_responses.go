...
func (o *GetV1RunbooksRunbookIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbooks/{runbook_id}] getV1RunbooksRunbookId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbooks runbook Id o k response
func (o *GetV1RunbooksRunbookIDOK) Code() int {
	return 200
}
