...
func (o *GetV1RunbooksActionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbooks/actions] getV1RunbooksActions", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbooks actions o k response
func (o *GetV1RunbooksActionsOK) Code() int {
	return 200
}
