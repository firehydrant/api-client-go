...
func (o *GetV1RunbooksExecutionsExecutionIDStepsStepIDScriptReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbooks/executions/{execution_id}/steps/{step_id}/script] getV1RunbooksExecutionsExecutionIdStepsStepIdScript", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbooks executions execution Id steps step Id script o k response
func (o *GetV1RunbooksExecutionsExecutionIDStepsStepIDScriptOK) Code() int {
	return 200
}
