...
func (o *PostV1RunbooksExecutionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/runbooks/executions] postV1RunbooksExecutions", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 runbooks executions created response
func (o *PostV1RunbooksExecutionsCreated) Code() int {
	return 201
}
