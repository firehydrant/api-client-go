...
func (o *GetV1RunbooksExecutionsExecutionIDVotesStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbooks/executions/{execution_id}/votes/status] getV1RunbooksExecutionsExecutionIdVotesStatus", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbooks executions execution Id votes status o k response
func (o *GetV1RunbooksExecutionsExecutionIDVotesStatusOK) Code() int {
	return 200
}
