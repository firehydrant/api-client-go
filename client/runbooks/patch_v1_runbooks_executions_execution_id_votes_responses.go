...
func (o *PatchV1RunbooksExecutionsExecutionIDVotesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/runbooks/executions/{execution_id}/votes] patchV1RunbooksExecutionsExecutionIdVotes", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 runbooks executions execution Id votes o k response
func (o *PatchV1RunbooksExecutionsExecutionIDVotesOK) Code() int {
	return 200
}
