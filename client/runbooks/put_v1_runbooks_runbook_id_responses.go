...
func (o *PutV1RunbooksRunbookIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /v1/runbooks/{runbook_id}] putV1RunbooksRunbookId", response, response.Code())
	}
}
...
// Code gets the status code for the put v1 runbooks runbook Id o k response
func (o *PutV1RunbooksRunbookIDOK) Code() int {
	return 200
}
