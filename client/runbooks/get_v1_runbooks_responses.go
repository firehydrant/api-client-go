...
func (o *GetV1RunbooksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbooks] getV1Runbooks", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbooks o k response
func (o *GetV1RunbooksOK) Code() int {
	return 200
}
