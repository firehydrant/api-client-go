...
func (o *GetV1RunbooksExecutionsExecutionIDStepsStepIDVotesStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbooks/executions/{execution_id}/steps/{step_id}/votes/status] getV1RunbooksExecutionsExecutionIdStepsStepIdVotesStatus", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbooks executions execution Id steps step Id votes status o k response
func (o *GetV1RunbooksExecutionsExecutionIDStepsStepIDVotesStatusOK) Code() int {
	return 200
}
