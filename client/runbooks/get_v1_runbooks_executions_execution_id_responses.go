...
func (o *GetV1RunbooksExecutionsExecutionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbooks/executions/{execution_id}] getV1RunbooksExecutionsExecutionId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbooks executions execution Id o k response
func (o *GetV1RunbooksExecutionsExecutionIDOK) Code() int {
	return 200
}
