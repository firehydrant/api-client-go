...
func (o *GetV1IncidentTagsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incident_tags] getV1IncidentTags", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incident tags o k response
func (o *GetV1IncidentTagsOK) Code() int {
	return 200
}
