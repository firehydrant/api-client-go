...
func (o *PostV1IncidentTagsValidateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/incident_tags/validate] postV1IncidentTagsValidate", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 incident tags validate created response
func (o *PostV1IncidentTagsValidateCreated) Code() int {
	return 201
}
