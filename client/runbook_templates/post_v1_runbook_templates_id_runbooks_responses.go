...
func (o *PostV1RunbookTemplatesIDRunbooksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/runbook_templates/{id}/runbooks] postV1RunbookTemplatesIdRunbooks", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 runbook templates Id runbooks created response
func (o *PostV1RunbookTemplatesIDRunbooksCreated) Code() int {
	return 201
}
