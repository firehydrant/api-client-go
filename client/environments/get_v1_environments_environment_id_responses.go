...
func (o *GetV1EnvironmentsEnvironmentIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/environments/{environment_id}] getV1EnvironmentsEnvironmentId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 environments environment Id o k response
func (o *GetV1EnvironmentsEnvironmentIDOK) Code() int {
	return 200
}
