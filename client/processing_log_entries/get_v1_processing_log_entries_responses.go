...
func (o *GetV1ProcessingLogEntriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/processing_log_entries] getV1ProcessingLogEntries", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 processing log entries o k response
func (o *GetV1ProcessingLogEntriesOK) Code() int {
	return 200
}
