...
// New creates a new processing log entries API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for processing log entries API
*/
type Client struct {
...
/*
GetV1ProcessingLogEntries processings log entries for a specific alert
