...
func (o *GetV1IncidentRolesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incident_roles] getV1IncidentRoles", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incident roles o k response
func (o *GetV1IncidentRolesOK) Code() int {
	return 200
}
