...
func (o *GetV1IncidentRolesIncidentRoleIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/incident_roles/{incident_role_id}] getV1IncidentRolesIncidentRoleId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 incident roles incident role Id o k response
func (o *GetV1IncidentRolesIncidentRoleIDOK) Code() int {
	return 200
}
