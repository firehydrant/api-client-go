...
func (o *PatchV1IncidentRolesIncidentRoleIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/incident_roles/{incident_role_id}] patchV1IncidentRolesIncidentRoleId", response, response.Code())
	}
}
...
func (o *PatchV1IncidentRolesIncidentRoleIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this patch v1 incident roles incident role Id o k response has a 3xx status code
func (o *PatchV1IncidentRolesIncidentRoleIDOK) IsRedirect() bool {
	return false
}
...
func (o *PatchV1IncidentRolesIncidentRoleIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the patch v1 incident roles incident role Id o k response
func (o *PatchV1IncidentRolesIncidentRoleIDOK) Code() int {
	return 200
}
...
func (o *PatchV1IncidentRolesIncidentRoleIDOK) String() string {
	return fmt.Sprintf("[PATCH /v1/incident_roles/{incident_role_id}][%d] patchV1IncidentRolesIncidentRoleIdOK  %+v", 200, o.Payload)
}
