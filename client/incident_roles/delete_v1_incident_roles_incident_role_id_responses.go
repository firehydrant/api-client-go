...
func (o *DeleteV1IncidentRolesIncidentRoleIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/incident_roles/{incident_role_id}] deleteV1IncidentRolesIncidentRoleId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 incident roles incident role Id o k response
func (o *DeleteV1IncidentRolesIncidentRoleIDOK) Code() int {
	return 200
}
