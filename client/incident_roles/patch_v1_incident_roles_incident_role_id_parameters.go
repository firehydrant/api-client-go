...
func (o *PatchV1IncidentRolesIncidentRoleIDParams) WithDefaults() *PatchV1IncidentRolesIncidentRoleIDParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *PatchV1IncidentRolesIncidentRoleIDParams) SetDefaults() {
