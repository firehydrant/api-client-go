...
type PostV1ConversationsConversationIDCommentsCommentIDReactionsParams struct {
	...
	// V1ConversationsConversationIDCommentsCommentIDReactions.
	V1ConversationsConversationIDCommentsCommentIDReactions *models.PostV1ConversationsConversationIDCommentsCommentIDReactions
...
// WithV1ConversationsConversationIDCommentsCommentIDReactions adds the v1ConversationsConversationIDCommentsCommentIDReactions to the post v1 conversations conversation Id comments comment Id reactions params
func (o *PostV1ConversationsConversationIDCommentsCommentIDReactionsParams) WithV1ConversationsConversationIDCommentsCommentIDReactions(v1ConversationsConversationIDCommentsCommentIDReactions *models.PostV1ConversationsConversationIDCommentsCommentIDReactions) *PostV1ConversationsConversationIDCommentsCommentIDReactionsParams {
	o.SetV1ConversationsConversationIDCommentsCommentIDReactions(v1ConversationsConversationIDCommentsCommentIDReactions)
	return o
}

// SetV1ConversationsConversationIDCommentsCommentIDReactions adds the v1ConversationsConversationIdCommentsCommentIdReactions to the post v1 conversations conversation Id comments comment Id reactions params
func (o *PostV1ConversationsConversationIDCommentsCommentIDReactionsParams) SetV1ConversationsConversationIDCommentsCommentIDReactions(v1ConversationsConversationIDCommentsCommentIDReactions *models.PostV1ConversationsConversationIDCommentsCommentIDReactions) {
	o.V1ConversationsConversationIDCommentsCommentIDReactions = v1ConversationsConversationIDCommentsCommentIDReactions
}
...
func (o *PostV1ConversationsConversationIDCommentsCommentIDReactionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.V1ConversationsConversationIDCommentsCommentIDReactions != nil {
		if err := r.SetBodyParam(o.V1ConversationsConversationIDCommentsCommentIDReactions); err != nil {
			return err
		}
	}
