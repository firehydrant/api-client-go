...
type PatchV1ConversationsConversationIDCommentsCommentIDParams struct {
	...
	V1ConversationsConversationIDComments *models.PatchV1ConversationsConversationIDComments
...
// WithV1ConversationsConversationIDComments adds the v1ConversationsConversationIDComments to the patch v1 conversations conversation Id comments comment Id params
func (o *PatchV1ConversationsConversationIDCommentsCommentIDParams) WithV1ConversationsConversationIDComments(v1ConversationsConversationIDComments *models.PatchV1ConversationsConversationIDComments) *PatchV1ConversationsConversationIDCommentsCommentIDParams {
	o.SetV1ConversationsConversationIDComments(v1ConversationsConversationIDComments)
	return o
}

// SetV1ConversationsConversationIDComments adds the v1ConversationsConversationIdComments to the patch v1 conversations conversation Id comments comment Id params
func (o *PatchV1ConversationsConversationIDCommentsCommentIDParams) SetV1ConversationsConversationIDComments(v1ConversationsConversationIDComments *models.PatchV1ConversationsConversationIDComments) {
