...
// WithPostV1ConversationsConversationIDComments adds the postV1ConversationsConversationIDComments to the post v1 conversations conversation Id comments params
func (o *PostV1ConversationsConversationIDCommentsParams) WithPostV1ConversationsConversationIDComments(postV1ConversationsConversationIDComments *models.PostV1ConversationsConversationIDComments) *PostV1ConversationsConversationIDCommentsParams {
	o.SetPostV1ConversationsConversationIDComments(postV1ConversationsConversationIDComments)
	return o
}

// SetPostV1ConversationsConversationIDComments adds the postV1ConversationsConversationIdComments to the post v1 conversations conversation Id comments params
func (o *PostV1ConversationsConversationIDCommentsParams) SetPostV1ConversationsConversationIDComments(postV1ConversationsConversationIDComments *models.PostV1ConversationsConversationIDComments) {
	o.PostV1ConversationsConversationIDComments = postV1ConversationsConversationIDComments
}
...
func (o *PostV1ConversationsConversationIDCommentsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.PostV1ConversationsConversationIDComments != nil {
		if err := r.SetBodyParam(o.PostV1ConversationsConversationIDComments); err != nil {
			return err
		}
	}
