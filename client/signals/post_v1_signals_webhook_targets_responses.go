...
func (o *PostV1SignalsWebhookTargetsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewPostV1SignalsWebhookTargetsCreated()
...
func NewPostV1SignalsWebhookTargetsCreated() *PostV1SignalsWebhookTargetsCreated {
	return &PostV1SignalsWebhookTargetsCreated{}
}
...
func (o *PostV1SignalsWebhookTargetsCreated) Error() string {
	return fmt.Sprintf("[POST /v1/signals/webhook_targets][%d] postV1SignalsWebhookTargetsCreated ", 201)
}
...
func (o *PostV1SignalsWebhookTargetsCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
