...
func (o *GetV1SignalsAnalyticsShiftsExportReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetV1SignalsAnalyticsShiftsExportOK()
...
func NewGetV1SignalsAnalyticsShiftsExportOK() *GetV1SignalsAnalyticsShiftsExportOK {
	return &GetV1SignalsAnalyticsShiftsExportOK{}
}
...
func (o *GetV1SignalsAnalyticsShiftsExportOK) Error() string {
	return fmt.Sprintf("[GET /v1/signals/analytics/shifts/export][%d] getV1SignalsAnalyticsShiftsExportOK ", 200)
}
...
func (o *GetV1SignalsAnalyticsShiftsExportOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
