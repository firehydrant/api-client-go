...
func (o *GetV1SignalsAnalyticsTimeseriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/signals/analytics/timeseries] getV1SignalsAnalyticsTimeseries", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 signals analytics timeseries o k response
func (o *GetV1SignalsAnalyticsTimeseriesOK) Code() int {
	return 200
}
