...
func (o *PostV1SignalsEmailTargetsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewPostV1SignalsEmailTargetsCreated()
...
func NewPostV1SignalsEmailTargetsCreated() *PostV1SignalsEmailTargetsCreated {
	return &PostV1SignalsEmailTargetsCreated{}
}
...
func (o *PostV1SignalsEmailTargetsCreated) Error() string {
	return fmt.Sprintf("[POST /v1/signals/email_targets][%d] postV1SignalsEmailTargetsCreated ", 201)
}
...
func (o *PostV1SignalsEmailTargetsCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
