...
func (o *GetV1SignalsTransposersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/signals/transposers] getV1SignalsTransposers", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 signals transposers o k response
func (o *GetV1SignalsTransposersOK) Code() int {
	return 200
}
