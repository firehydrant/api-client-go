...
func (o *PatchV1SignalsEmailTargetsIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchV1SignalsEmailTargetsIDOK()
...
func NewPatchV1SignalsEmailTargetsIDOK() *PatchV1SignalsEmailTargetsIDOK {
	return &PatchV1SignalsEmailTargetsIDOK{}
}
...
func (o *PatchV1SignalsEmailTargetsIDOK) Error() string {
	return fmt.Sprintf("[PATCH /v1/signals/email_targets/{id}][%d] patchV1SignalsEmailTargetsIdOK ", 200)
}
...
func (o *PatchV1SignalsEmailTargetsIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
