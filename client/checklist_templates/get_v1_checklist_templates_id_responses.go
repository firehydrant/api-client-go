...
func (o *GetV1ChecklistTemplatesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/checklist_templates/{id}] getV1ChecklistTemplatesId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 checklist templates Id o k response
func (o *GetV1ChecklistTemplatesIDOK) Code() int {
	return 200
}
