...
func (o *PatchV1ChecklistTemplatesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/checklist_templates/{id}] patchV1ChecklistTemplatesId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 checklist templates Id o k response
func (o *PatchV1ChecklistTemplatesIDOK) Code() int {
	return 200
}
