...
func (o *GetV1ChecklistTemplatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/checklist_templates] getV1ChecklistTemplates", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 checklist templates o k response
func (o *GetV1ChecklistTemplatesOK) Code() int {
	return 200
}
