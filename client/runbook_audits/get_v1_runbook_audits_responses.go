...
func (o *GetV1RunbookAuditsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/runbook_audits] getV1RunbookAudits", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 runbook audits o k response
func (o *GetV1RunbookAuditsOK) Code() int {
	return 200
}
