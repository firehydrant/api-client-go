...
import (
	...
	"github.com/firehydrant/api-client-go/client/commenting"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *FireHydrantAPI {
	...
	cli.Commenting = commenting.New(transport, formats)
...
type FireHydrantAPI struct {
	...
	Commenting commenting.ClientService
...
func (c *FireHydrantAPI) SetTransport(transport runtime.ClientTransport) {
	...
	c.Commenting.SetTransport(transport)
