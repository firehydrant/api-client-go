...
func (o *DeleteV1ScheduledMaintenancesScheduledMaintenanceIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/scheduled_maintenances/{scheduled_maintenance_id}] deleteV1ScheduledMaintenancesScheduledMaintenanceId", response, response.Code())
	}
}
...
// Code gets the status code for the delete v1 scheduled maintenances scheduled maintenance Id no content response
func (o *DeleteV1ScheduledMaintenancesScheduledMaintenanceIDNoContent) Code() int {
	return 204
}
