...
func (o *GetV1ScheduledMaintenancesScheduledMaintenanceIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/scheduled_maintenances/{scheduled_maintenance_id}] getV1ScheduledMaintenancesScheduledMaintenanceId", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 scheduled maintenances scheduled maintenance Id o k response
func (o *GetV1ScheduledMaintenancesScheduledMaintenanceIDOK) Code() int {
	return 200
}
