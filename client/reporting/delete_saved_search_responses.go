...
func (o *DeleteSavedSearchOK) Error() string {
	return fmt.Sprintf("[DELETE /v1/saved_searches/{resource_type}/{saved_search_id}][%d] deleteSavedSearchOK  %+v", 200, o.Payload)
}
...
func (o *DeleteSavedSearchOK) GetPayload() *models.SavedSearchEntity {
	return o.Payload
}
