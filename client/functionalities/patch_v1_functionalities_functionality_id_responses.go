...
func (o *PatchV1FunctionalitiesFunctionalityIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/functionalities/{functionality_id}] patchV1FunctionalitiesFunctionalityId", response, response.Code())
	}
}
...
// Code gets the status code for the patch v1 functionalities functionality Id o k response
func (o *PatchV1FunctionalitiesFunctionalityIDOK) Code() int {
	return 200
}
