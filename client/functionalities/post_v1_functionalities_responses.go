...
func (o *PostV1FunctionalitiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/functionalities] postV1Functionalities", response, response.Code())
	}
}
...
// Code gets the status code for the post v1 functionalities created response
func (o *PostV1FunctionalitiesCreated) Code() int {
	return 201
}
