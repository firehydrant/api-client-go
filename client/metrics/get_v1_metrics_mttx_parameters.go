...
// WithPostmortemCompletedAtOrAfter adds the postmortemCompletedAtOrAfter to the get v1 metrics mttx params
func (o *GetV1MetricsMttxParams) WithPostmortemCompletedAtOrAfter(postmortemCompletedAtOrAfter *strfmt.DateTime) *GetV1MetricsMttxParams {
	o.SetPostmortemCompletedAtOrAfter(postmortemCompletedAtOrAfter)
	return o
}

// SetPostmortemCompletedAtOrAfter adds the postmortemCompletedAtOrAfter to the get v1 metrics mttx params
func (o *GetV1MetricsMttxParams) SetPostmortemCompletedAtOrAfter(postmortemCompletedAtOrAfter *strfmt.DateTime) {
	o.PostmortemCompletedAtOrAfter = postmortemCompletedAtOrAfter
}

// WithPostmortemCompletedAtOrBefore adds the postmortemCompletedAtOrBefore to the get v1 metrics mttx params
func (o *GetV1MetricsMttxParams) WithPostmortemCompletedAtOrBefore(postmortemCompletedAtOrBefore *strfmt.DateTime) *GetV1MetricsMttxParams {
	o.SetPostmortemCompletedAtOrBefore(postmortemCompletedAtOrBefore)
	return o
}

// SetPostmortemCompletedAtOrBefore adds the postmortemCompletedAtOrBefore to the get v1 metrics mttx params
func (o *GetV1MetricsMttxParams) SetPostmortemCompletedAtOrBefore(postmortemCompletedAtOrBefore *strfmt.DateTime) {
