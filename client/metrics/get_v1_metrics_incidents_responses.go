...
func (o *GetV1MetricsIncidentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/metrics/incidents] getV1MetricsIncidents", response, response.Code())
	}
}
...
// Code gets the status code for the get v1 metrics incidents o k response
func (o *GetV1MetricsIncidentsOK) Code() int {
	return 200
}
